...
use hal::port::mode::{Input, Output, PullUp};
...
impl Registers {
    ...
    pub fn set_adc_channels_selected(
        &mut self,
        new_selected: u8,
...
impl SpiState {
    ...
    pub fn new(
        spidev: avr_device::atmega328p::SPI,
    ...
    fn send_byte(&mut self, b: u8, _cs: &interrupt::CriticalSection) {
        unsafe {
            self.spi.spdr.write(|w| w.bits(b));
        }
    }
